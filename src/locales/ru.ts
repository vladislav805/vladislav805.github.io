        ...
        "items": {
            ...
            "apidog": {
                ...
                "description": [
                    ...
                    "Сайт разрабатывался примерно до 2017 года. В 2020 году был почти полностью переписан на ES6 с использованием webpack+babel и SCSS, затем, через пару месяцев на TypeScript."
                ],
                "view": "Открыть"
            }
        }
